// from https://github.com/raulgrell/tetris/blob/master/src/platform/web/webgl.js
// TODO: Double-check int/uint for added functions
...
pub extern fn glVertexAttribDivisor(index: c_uint, divisor: c_uint) void;
pub extern fn glDrawArrays(_: c_uint, _: c_uint, _: c_uint) void;
pub extern fn glDrawArraysInstanced(mode: c_uint, first: c_uint, count: c_uint, instanceCount: c_uint) void;
pub extern fn glDrawElementsInstanced(mode: c_uint, count: c_uint, type: c_uint, offset: c_uint, instanceCount: c_uint) void;
